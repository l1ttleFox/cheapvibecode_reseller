...
export const modelSnapshot = {
  ...
  'gpt-6-astra': {"multiplier":6.5,"cachedDiscount":1,"vision":true,"input":["text","image"],"output":["text"],"uptime":0.97719,"requests":83390,"success":81488},
  'qwen3.8-max': {"multiplier":3,"cachedDiscount":1,"vision":true,"input":["text","image","video"],"output":["text"],"uptime":0.99714,"requests":1747,"success":1742},
  'gpt-5.5': {"multiplier":2.5,"cachedDiscount":1,"vision":true,"input":["text","image"],"output":["text"],"uptime":0.97403,"requests":3927,"success":3825},
  'gpt-5.6-sol': {"multiplier":2.5,"cachedDiscount":1,"vision":true,"input":["text","image"],"output":["text"],"uptime":0.98098,"requests":72833,"success":71448},
  ...
  'gemini-3.5-flash': {"multiplier":2,"cachedDiscount":1,"vision":true,"input":["text","image","audio","video","pdf"],"output":["text"],"uptime":0.9594,"requests":6429,"success":6168},
  ...
  'gpt-5.6-terra': {"multiplier":1.2,"cachedDiscount":1,"vision":true,"input":["text","image"],"output":["text"],"uptime":0.9823,"requests":88351,"success":86787},
  ...
  'qwen3.8-flash': {"multiplier":1,"cachedDiscount":1,"vision":true,"input":["text","image","video"],"output":["text"],"uptime":0.99252,"requests":802,"success":796},
  ...
  'muse-spark-1.3': {"multiplier":0.07,"cachedDiscount":1,"vision":true,"input":["text","image","video","pdf"],"output":["text"],"uptime":0.96476,"requests":8485,"success":8186},
  ...
  'gpt-image-2': {"uptime":0.91977,"requests":5297,"success":4872},
  'codex-auto-review': {"uptime":1,"requests":579,"success":579},
  'web_search': {"uptime":0.95082,"requests":122,"success":116},
  'grok-imagine-image': {"uptime":0.97059,"requests":34,"success":33},
  'codex-transcribe': {"uptime":1,"requests":17,"success":17},
  'grok-imagine-video': {"uptime":0.2,"requests":10,"success":2},
  'gpt-4o-transcribe': {"standalone":true},
};
